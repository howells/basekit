...
import {
  ...
  LIB_PACKAGES,
  INTERNAL_REGISTRY,
  INTERNAL_SPECIFIER_TARGETS,
  CSS_STYLE,
  STRIP_GLOBAL_DECLARATIONS,
  STYLE_B_CSS,
  CANONICAL_CSS_VARS,
  EXPECTED_ITEM_NAMES,
} from "./build-registry-config.mjs";
...
/**
 * Re-declared here so the imported `LIB_PACKAGES` keeps its element type; a
 * JSDoc typedef does not cross a module boundary with the value it describes.
 *
 * @typedef {import("./build-registry-config.mjs").LibPackage} LibPackage
 */

...
const Tag = React.forwardRef<HTMLSpanElement, TagProps>(
  (
    ...
    const defaultProps: useRender.ElementProps<"span"> = {
      className: cx(
        // base
        "inline-flex items-center gap-x-2.5 rounded-full py-1 text-sm",
        // padding - adjust for avatar
        avatar
          ? removable
            ? "pl-1 pr-1"
            : "pl-1 pr-2.5"
        ...
        <>
            ...
            {count !== undefined && (
              <span
                className={cx(
                  ...
                  "ml-1.5 font-normal text-zinc-500 dark:text-zinc-400",
                  countClassName
                )}
              >
                {count}
          ...
          {removable && (
            <button
              ...
              className={cx(
                // base
                "-ml-1.5 flex size-5 items-center justify-center rounded-full",
                // text color

...
const options = [
  ...
  { 
    value: "profile", 
    label: "Profile", 
    leftIcon: ({ className }) => <UserIcon className={className} />
  },
  { 
    value: "settings", 
    label: "Settings", 
    leftIcon: ({ className }) => <SettingsIcon className={className} />
  },
  { 
    value: "help", 
    label: "Help", 
    leftIcon: ({ className }) => <HelpIcon className={className} />
  },
];
    ...
    selectedOption ? (
      <div className="flex items-center gap-2">
        ...
        <div className="text-left">
          ...
          <div className="text-xs text-zinc-500">{selectedOption.email}</div>
        </div>
      </div>
    ) : (
      "Select a user..."
...
<div className="space-y-4">
  ...
  <div className="flex gap-2">
    ...
    },
    {
      ...
      code: `const combobox = useCombobox("apple");

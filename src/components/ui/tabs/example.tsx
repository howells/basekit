    ...
    <Tabs defaultValue={defaultValue} {...props}>
      ...
      <TabsContent value="overview" className="mt-6 space-y-4">
        ...
        <p className="text-sm text-zinc-600 dark:text-zinc-400">
          This is the overview tab content. Here you can see a summary of your
          account activity, recent updates, and key metrics at a glance.
        </p>
      ...
      <TabsContent value="reports" className="mt-6 space-y-4">
        ...
        <p className="text-sm text-zinc-600 dark:text-zinc-400">
          Generate and download various reports including user activity, system
          performance, and custom data exports.
        </p>

  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-2">
        ...
        <RadioGroup value={planValue} onValueChange={setPlanValue}>
          <RadioOption 
            value="basic" 
            label="Basic Plan" 
      ...
      <div className="space-y-2">
        ...
        <RadioGroup value={disabledValue} onValueChange={setDisabledValue}>
      ...
      <div className="space-y-2">
        ...
        <RadioGroup value={customValue} onValueChange={setCustomValue}>
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="flex flex-col">
              <span className="text-sm font-medium text-zinc-400">Custom Item 3</span>
              <span className="text-xs text-zinc-500 dark:text-zinc-400">
